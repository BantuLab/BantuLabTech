    ...
    >
      <v-card-text>
        ...
        >
          ...
          <!-- <a v-bind:href="icon.url" target="_blank"></a> -->
        </v-btn>
      </v-card-text>
      ...
      <v-card-text class="white--text pt-0">
               ...
               <p>
                 <a href="http://bit.ly/BantuLabTechSlack" target="_blank" class="white--text">Get creative and join us now!</a>
               </p>
      </v-card-text>
      ...
      <v-card-text class="white--text">
        &copy;{{year}} — <strong>BantuLab, Inc.</strong>
      </v-card-text>
    </v-card>
  </v-footer>
</template>
  ...
  export default {
    data: () => ({
      icons: [
        ...
        { value: 'fab fa-twitter', url: 'https://www.twitter.com/bantulabtech' }
      ]
    }),
    methods: {
